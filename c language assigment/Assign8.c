...
int s1()
{
    ...
    scanf("%d", &x);
    if (x / 1000)
    { // [ EXP: 123/1000 output : = 1234 ] 1.first condition is [false]
        printf(" not three digit ");
    }
    else if (x / 100)
    { // [123/100  output: = 123]  2. second conditon is [ true ]
        printf("Yes number is three digit ");
    }
    else if (x / 10)
    { //[ EXP: 123/10 output : = 12 ] 3. third conditon is [false]
        printf(" not three digit ");
    }
    else if (x / 1)
    { //[ EXP: 123/1 output : = 1 ] 4. fourth conditon is [false]
        printf(" not three digit");
    }
    return 0;
}
